...
*Not in any milestone: gallery-link-on-receipt evolution (§12), AI features. M5 starts only after M4 is green — do not start post-M4 work early.*

---

*Phase 2 (Box pivot) tasks — API-090..111, milestones M9–M11 — live in [potoku-api-phase2.md](potoku-api-phase2.md).*
